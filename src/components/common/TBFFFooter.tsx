    ...
    <footer className="bg-slate-800 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-5 gap-8">
          {/* Company Logos Section - Takes up more space */}
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {/* Partner Company Placeholder */}
              <div className="flex flex-col items-center text-center">
                <div className="mb-4">
                  <div className="text-primary text-xl font-bold">Partner Company</div>
                  <div className="text-sm tracking-wider">TAGLINE</div>
                </div>
                {/* Placeholder for logo - replace src with actual logo */}
                <div className="w-40 h-24 bg-slate-700 rounded-lg flex items-center justify-center mb-4">
                ...
                <div className="flex space-x-3 mt-auto">
                  <a
                    ...
                    aria-label="TikTok"
                    className="w-8 h-8 rounded-full border-2 border-[#fbddda] flex items-center justify-center hover:bg-[#fbddda] hover:text-slate-800 transition-colors"
                  >
              ...
              {/* Imagine Beyond Travel - styled as partner */}
              <div className="flex flex-col items-center text-center">
                <div className="mb-4">
                  <div className="text-[#fbddda] text-xl font-bold">Imagine beyond</div>
                  <div className="text-sm tracking-wider">TRAVEL</div>
                </div>
                <img
                  src={ibtLogo}
                  alt="IBT Logo"
                ...
                <div className="flex space-x-3 mt-auto">
                  <a
                    ...
                    rel="noopener noreferrer"
                    aria-label="TikTok"
                    className="w-8 h-8 rounded-full border-2 border-[#0FC2BF] flex items-center justify-center hover:bg-[#0FC2BF] hover:text-white transition-colors"
                  >
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-.88-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43V7.56a8.16 8.16 0 004.77 1.17v-3.4a4.85 4.85 0 01-1-.64z"/>
                    </svg>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Follow us on social media to stay updated on our latest trips and travel tips.</p>
          </div>
        </div>
